...
#Request.create! service_request_id: "49327899999", status: "closed", service_name: "test", service_code: "TEST", \
#  description: "", requested_datetime: "2013-04-11 12:33".to_datetime
@r = Request.create service_request_id: "2323", status: "open", service_name: "garbage", service_code: "GARB", \
  description: "ticket with notes", requested_datetime: "2013-04-01 10:48".to_datetime
